...
const testAccCloudProjectDatabaseDatabaseDatasourceConfig_Basic = `
...
func TestAccCloudProjectDatabaseDatabaseDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudProjectDatabaseDatabaseDatasourceConfig_Basic,
		serviceName,
		description,
		engine,
		version,
