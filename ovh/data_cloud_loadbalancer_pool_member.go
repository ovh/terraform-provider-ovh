...
// loadbalancerPoolMemberDataSourceCurrentStateSchema returns the schema for the computed
// current_state attribute of a member, shared by the singular and plural data sources.
func loadbalancerPoolMemberDataSourceCurrentStateSchema() schema.SingleNestedAttribute {
