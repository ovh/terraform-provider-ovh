...
// network + file share on that subnet (no companion file_share_acl resource, so
// the instance owns the share's rules), and an instance on the same subnet
// attaching the share. accessLevelLine is the optional
