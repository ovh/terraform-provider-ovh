...
const testAccCloudProjectDatabaseIntegrationDatasourceConfig_Basic = `
...
func TestAccCloudProjectDatabaseIntegrationDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudProjectDatabaseIntegrationDatasourceConfig_Basic,
		serviceName,
		descriptionPsql,
		versionPsql,
		region,
