...
const testAccCloudManagedDatabaseLogSubsriptionDatasourceConfig_Basic = `
...
data "ovh_cloud_managed_database_log_subscription" "sub" {
...
func TestAccCloudManagedDatabaseLogSubscriptionDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseLogSubsriptionDatasourceConfig_Basic,
		serviceName,
		description,
		engine,
		version,
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet(
						"ovh_cloud_managed_database_log_subscription.sub",
						"created_at",
					),
					resource.TestCheckResourceAttrSet(
						"ovh_cloud_managed_database_log_subscription.sub",
