...
const testAccCloudManagedAnalyticsKafkaAclsDatasourceConfig_Basic = `
...
func TestAccCloudManagedAnalyticsKafkaAclsDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedAnalyticsKafkaAclsDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
