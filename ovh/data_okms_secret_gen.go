...
func (v OkmsSecretModel) ToCreate() *OkmsSecretModel {
	res := &OkmsSecretModel{}

	if !v.Metadata.IsUnknown() {
		if meta := v.Metadata.ToCreate(); meta != nil {
			res.Metadata = *meta
		}
	}
...
func (v OkmsSecretModel) ToUpdate() *OkmsSecretModel {
	res := &OkmsSecretModel{}

	if !v.Metadata.IsUnknown() {
		res.Metadata = *v.Metadata.ToUpdate()
	}

	if !v.Version.Data.IsUnknown() && !v.Version.Data.IsNull() {
		res.Version = *v.Version.ToUpdate()
	}
