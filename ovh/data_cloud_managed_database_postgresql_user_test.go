...
const testAccCloudManagedDatabasePostgresqlUserDatasourceConfig_Basic = `
...
data "ovh_cloud_managed_database_postgresql_user" "user" {
...
func TestAccCloudManagedDatabasePostgresqlUserDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabasePostgresqlUserDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
