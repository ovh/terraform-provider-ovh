...
// loadbalancerListenerDataSourceCurrentStateSchema returns the schema for the computed
// current_state attribute of a listener, shared by the singular and plural data sources.
func loadbalancerListenerDataSourceCurrentStateSchema() schema.SingleNestedAttribute {
