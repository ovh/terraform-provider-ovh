...
const testAccCloudManagedDatabaseUserDatasourceConfig_Basic = `
...
data "ovh_cloud_managed_database_user" "user" {
...
func TestAccCloudManagedDatabaseUserDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseUserDatasourceConfig_Basic,
		serviceName,
		description,
		engine,
		version,
