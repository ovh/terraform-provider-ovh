		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ovh_ovhcloud_connect_config_pop_datacenters.datacenter_cfgs", "pop_id"),
					...
					resource.TestCheckResourceAttr("data.ovh_ovhcloud_connect_config_pop_datacenters.datacenter_cfgs", "datacenter_configs.0.service_name", serviceName),
