...
const testAccCloudManagedDatabaseUsersDatasourceConfig_Basic = `
...
func TestAccCloudManagedDatabaseUsersDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseUsersDatasourceConfig_Basic,
		serviceName,
		description,
		engine,
		version,
