...
func init() {
	resource.AddTestSweepers("ovh_cloud_managed_kubernetes_nodepool", &resource.Sweeper{
		Name: "ovh_cloud_managed_kubernetes_nodepool",
...
resource "ovh_cloud_managed_kubernetes_nodepool" "pool" {
  ...
  name          = ovh_cloud_managed_kubernetes.cluster.name
  flavor_name   = "b2-7"
  desired_nodes = 1
  min_nodes     = 0
  max_nodes     = 1
...
func TestAccCloudManagedKubernetesNodePoolRessource(t *testing.T) {
	name := acctest.RandomWithPrefix(test_prefix)
	region := os.Getenv("OVH_CLOUD_PROJECT_KUBE_REGION_TEST")
	version := os.Getenv("OVH_CLOUD_PROJECT_KUBE_VERSION_TEST")
	resourceName := "ovh_cloud_managed_kubernetes_nodepool.pool"
	config := fmt.Sprintf(
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "name", name),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "flavor_name", "b2-7"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "desired_nodes", "1"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "min_nodes", "0"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "max_nodes", "100"),

					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.metadata.0.annotations.a1", "av1"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.metadata.0.finalizers.0", "finalizer.extensions/v1beta1"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.metadata.0.labels.l1", "lv1"),

					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.spec.0.taints.0.effect", "PreferNoSchedule"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.spec.0.taints.0.key", "t1"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.spec.0.taints.0.value", "tv1"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.spec.0.unschedulable", "false"),
				),
			},
			{
				Config: config,
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "desired_nodes", "1"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "min_nodes", "0"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "max_nodes", "1"),
			...
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "name", name),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "flavor_name", "b2-7"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "desired_nodes", "2"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "min_nodes", "0"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "max_nodes", "2"),

					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.metadata.0.annotations.a2", "av2"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.metadata.0.finalizers.#", "0"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.metadata.0.labels.l2", "lv2"),

					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.spec.0.taints.#", "0"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.spec.0.unschedulable", "false"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "name", name),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "flavor_name", "b2-7"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "desired_nodes", "0"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "min_nodes", "0"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "max_nodes", "2"),
					...
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.spec.0.taints.#", "0"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "template.0.spec.0.unschedulable", "false"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_utilization_threshold", "0.5"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unneeded_time_seconds", "600"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unready_time_seconds", "1200"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_utilization_threshold", "0.1"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unneeded_time_seconds", "111"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unready_time_seconds", "1111"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_utilization_threshold", "0.1"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unneeded_time_seconds", "222"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unready_time_seconds", "1111"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_utilization_threshold", "0.1"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unneeded_time_seconds", "222"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unready_time_seconds", "2222"),
				),
			},
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_utilization_threshold", "0.2"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unneeded_time_seconds", "222"),
					resource.TestCheckResourceAttr("ovh_cloud_managed_kubernetes_nodepool.pool", "autoscaling_scale_down_unready_time_seconds", "2222"),
				),
			},
			{
				...
				ImportStateIdFunc: func(state *terraform.State) (string, error) {
					...
					kubernetesClusterID := state.RootModule().Resources["ovh_cloud_managed_kubernetes.cluster"].Primary.ID
...
func TestAccCloudManagedKubernetesNodePoolTaints(t *testing.T) {
	resource.Test(t, resource.TestCase{
		PreCheck: func() {
			testAccPreCheckCloud(t)
			testAccCheckCloudProjectExists(t)
