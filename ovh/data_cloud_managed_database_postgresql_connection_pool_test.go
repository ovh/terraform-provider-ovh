...
const testAccCloudManagedDatabasePostgresqlConnectionPoolDatasourceConfig_Basic = testAccCloudManagedDatabasePostgresqlConnectionPoolConfig + `

data "ovh_cloud_managed_database_postgresql_connection_pool" "connection_pool" {
...
func TestAccCloudManagedDatabasePostgresqlConnectionPoolDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabasePostgresqlConnectionPoolDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
