...
func (d *cloudInstanceGroupDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Get information about an instance group in a public cloud project.",
		Attributes: map[string]schema.Attribute{
			...
			"instance_group_id": schema.StringAttribute{
				...
				MarkdownDescription: "ID of the instance group",
			},
...
func (d *cloudInstanceGroupDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data CloudInstanceGroupDataSourceModel
	...
	endpoint := "/v2/publicCloud/project/" + url.PathEscape(data.ServiceName.ValueString()) +
		"/compute/instanceGroup/" + url.PathEscape(data.InstanceGroupId.ValueString())
