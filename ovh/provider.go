...
func Provider() *schema.Provider {
	return &schema.Provider{
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"ovh_cloud_project_database_mongodb_user":                     resourceCloudProjectDatabasepMongodbUser(),
			"ovh_cloud_project_database_postgresql_user":                  resourceCloudProjectDatabasepPostgresqlUser(),
			"ovh_cloud_project_database_redis_user":                       resourceCloudProjectDatabasepRedisUser(),
