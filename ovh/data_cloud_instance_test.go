		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttrSet("data.ovh_cloud_instance.test", "current_state.networks.0.addresses.#"),
					resource.TestCheckResourceAttrSet("data.ovh_cloud_instance.test", "current_state.networks.0.addresses.0.ip"),
