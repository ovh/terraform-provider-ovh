...
func (d *cloudInstanceGroupsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description:         "Use this data source to list the instance groups (placement groups) of a public cloud project. An instance group is immutable once created: there is no update route and its membership is fixed at instance-creation time.",
		MarkdownDescription: "Use this data source to list the instance groups (placement groups) of a public cloud project. An instance group is immutable once created: there is no update route and its membership is fixed at instance-creation time.",
		Attributes: map[string]schema.Attribute{
			...
			"instance_groups": schema.ListNestedAttribute{
				Computed:            true,
				Description:         "Instance groups (placement groups) belonging to the project, across every region.",
				MarkdownDescription: "Instance groups (placement groups) belonging to the project, across every region.",
				NestedObject:        schema.NestedAttributeObject{Attributes: instanceGroupDataSourceAttributes()},
			},
		},
	}
}
