...
// No UpdatedAt: instance groups are immutable (no PUT route), so the API
// envelope deliberately omits updatedAt — confirmed against apiv2
// internal/model/instance_group.go and publicCloud.instanceGroup.InstanceGroup.json.
