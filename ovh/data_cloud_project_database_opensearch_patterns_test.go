...
const testAccCloudProjectDatabaseOpensearchPatternsDatasourceConfig_Basic = `
...
func TestAccCloudProjectDatabaseOpensearchPatternsDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudProjectDatabaseOpensearchPatternsDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
