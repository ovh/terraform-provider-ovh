...
const testAccCloudManagedDatabaseMongodbPrometheusDatasourceConfig_Basic = `
...
func TestAccCloudManagedDatabaseMongodbPrometheusDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseMongodbPrometheusDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
