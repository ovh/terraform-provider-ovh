...
// loadbalancerL7PolicyDataSourceCurrentStateSchema returns the schema for the computed
// current_state attribute of a L7 policy, shared by the singular and plural data sources.
func loadbalancerL7PolicyDataSourceCurrentStateSchema() schema.SingleNestedAttribute {
