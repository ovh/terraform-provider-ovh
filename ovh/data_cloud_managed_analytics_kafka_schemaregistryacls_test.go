...
const testAccCloudManagedAnalyticsKafkaSchemaRegistryAclsDatasourceConfig_Basic = `
...
data "ovh_cloud_managed_analytics_kafka_schemaregistryacls" "schemaRegistryAcls" {
...
func TestAccCloudManagedAnalyticsKafkaSchemaRegistryAclsDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedAnalyticsKafkaSchemaRegistryAclsDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
