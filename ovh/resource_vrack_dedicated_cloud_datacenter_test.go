		...
		Steps: []resource.TestStep{
			{
				...
				`, serviceName, dedicatedCloudDatacenter, targetServiceName),
				Check: resource.ComposeTestCheckFunc(
					...
					resource.TestCheckResourceAttr("ovh_vrack_dedicated_cloud_datacenter.vrack-dedicatedCloudDatacenter", "target_service_name", targetServiceName),
				),
			},
		},
	})
