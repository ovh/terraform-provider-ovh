...
const testAccCloudManagedDatabaseIntegrationsDatasourceConfig_Basic = `
...
data "ovh_cloud_managed_database_integrations" "integrations" {
...
func TestAccCloudManagedDatabaseIntegrationsDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseIntegrationsDatasourceConfig_Basic,
		serviceName,
		descriptionPsql,
		versionPsql,
		region,
