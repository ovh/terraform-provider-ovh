...
func TestAccCloudManagedKubernetesOIDCDataSource_basic(t *testing.T) {
...
data "ovh_cloud_managed_kubernetes_oidc" "oidcData" {
	...
	depends_on = [
		ovh_cloud_managed_kubernetes_oidc.oidc
	]
}
`
