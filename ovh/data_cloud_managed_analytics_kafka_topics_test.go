...
const testAccCloudManagedAnalyticsKafkaTopicsDatasourceConfig_Basic = `
...
func TestAccCloudManagedAnalyticsKafkaTopicsDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedAnalyticsKafkaTopicsDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
