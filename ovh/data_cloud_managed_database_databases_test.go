...
const testAccCloudManagedDatabaseDatabasesDatasourceConfig_Basic = `
...
func TestAccCloudManagedDatabaseDatabasesDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseDatabasesDatasourceConfig_Basic,
		serviceName,
		description,
		engine,
		version,
