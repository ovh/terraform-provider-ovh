...
const testAccCloudManagedAnalyticsKafkaUserAccessDatasourceConfig_Basic = `
...
func TestAccCloudManagedAnalyticsKafkaUserAccessDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedAnalyticsKafkaUserAccessDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
