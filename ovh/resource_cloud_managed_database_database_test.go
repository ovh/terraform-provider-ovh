...
const testAccCloudManagedDatabaseDatabaseConfig = `
...
func TestAccCloudManagedDatabaseDatabase_basic(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttrSet(
						"ovh_cloud_managed_database_database.database", "default"),
					resource.TestCheckResourceAttr(
						"ovh_cloud_managed_database_database.database", "name", name,
					),
				),
			},
		},
