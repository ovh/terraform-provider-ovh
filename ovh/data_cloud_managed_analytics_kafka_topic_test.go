...
const testAccCloudManagedAnalyticsKafkaTopicDatasourceConfig_Basic = `
...
func TestAccCloudManagedAnalyticsKafkaTopicDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedAnalyticsKafkaTopicDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
