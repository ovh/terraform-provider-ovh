...
const testAccCloudManagedDatabaseRedisUserDatasourceConfig = `
...
data "ovh_cloud_managed_database_redis_user" "user" {
...
func TestAccCloudManagedDatabaseRedisUserDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseRedisUserDatasourceConfig,
		serviceName,
		description,
		version,
		region,
