...
func (p *OvhProvider) DataSources(_ context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		...
		NewCloudProjectRancherCapabilitiesPlanDataSource,
		NewCloudProjectRancherCapabilitiesVersionDataSource,
		NewCloudInstanceAutobackupDataSource,
		NewCloudProjectRancherDataSource,
		NewCloudProjectRancherPlanDataSource,
		NewCloudProjectRancherVersionDataSource,
		NewCloudProjectSshKeyDataSource,
		NewCloudProjectSshKeysDataSource,
		...
		NewCloudProjectStorageLifecycleConfigurationDataSource,
		NewCloudStorageObjectBucketObjectDataSource,
		NewCloudStorageObjectBucketObjectsDataSource,
		NewCloudStorageObjectBucketObjectVersionsDataSource,
		...
		NewStorageEfsDataSource,
		NewStorageEfsShareAccessPathsDataSource,
...
func (p *OvhProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		NewCloudStorageObjectBucketObjectLockResource,
		...
		NewCloudInstanceAutobackupResource,
