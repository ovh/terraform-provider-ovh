...
const testAccCloudProjectDatabaseValkeyUserDatasourceConfig = `
...
data "ovh_cloud_project_database_valkey_user" "user" {
...
func TestAccCloudProjectDatabaseValkeyUserDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudProjectDatabaseValkeyUserDatasourceConfig,
		serviceName,
		description,
		version,
		region,
