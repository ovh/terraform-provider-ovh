...
const testAccCloudManagedDatabaseDatasourceConfig_Basic = `
...
func TestAccCloudManagedDatabaseDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseDatasourceConfig_Basic,
		serviceName,
		description,
		engine,
		version,
