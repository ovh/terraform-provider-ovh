...
const testAccCloudManagedDatabaseLogSubsriptionsDatasourceConfig_Basic = `
...
data "ovh_cloud_managed_database_log_subscriptions" "subs" {
...
func TestAccCloudManagedDatabaseLogSubscriptionsDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseLogSubsriptionsDatasourceConfig_Basic,
		serviceName,
		description,
		engine,
		version,
