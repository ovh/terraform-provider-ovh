...
const testAccCloudManagedDatabaseMongodbUserDatasourceConfig_Basic = `
...
data "ovh_cloud_managed_database_mongodb_user" "user" {
...
func TestAccCloudManagedDatabaseMongodbUserDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabaseMongodbUserDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
