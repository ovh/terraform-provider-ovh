...
func (v MetadataValue) ToUpdate() *MetadataValue {
	res := &MetadataValue{}

	if !v.CustomMetadata.IsNull() {
		res.CustomMetadata = v.CustomMetadata
	}

	if !v.DeactivateVersionAfter.IsNull() {
		res.DeactivateVersionAfter = v.DeactivateVersionAfter
	}

	if !v.MaxVersions.IsNull() {
		res.MaxVersions = v.MaxVersions
	}
...
func (v MetadataValue) ToCreate() *MetadataValue {
	return nil
}
...
func (v SecretVersionValue) ToCreate() *SecretVersionValue {
	res := &SecretVersionValue{}
	...
	if !v.DeactivatedAt.IsNull() {
		res.DeactivatedAt = v.DeactivatedAt
	}
...
func (v SecretVersionValue) ToUpdate() *SecretVersionValue {
	res := &SecretVersionValue{}
