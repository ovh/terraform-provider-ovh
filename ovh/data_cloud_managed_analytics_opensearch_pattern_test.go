...
const testAccCloudManagedAnalyticsOpensearchPatternDatasourceConfig_Basic = `
...
func TestAccCloudManagedAnalyticsOpensearchPatternDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedAnalyticsOpensearchPatternDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
