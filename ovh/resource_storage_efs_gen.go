...
func StorageEfsResourceSchema(ctx context.Context) schema.Schema {
	attrs := map[string]schema.Attribute{
		...
		"name": schema.StringAttribute{
			...
			MarkdownDescription: "Custom service name",
		},
...
type StorageEfsResourceModel struct {
...
func (v *StorageEfsResourceModel) MergeWith(other *StorageEfsResourceModel) {
...
type StorageEfsResourceWritableModel struct {
	Name *ovhtypes.TfStringValue `tfsdk:"name" json:"name,omitempty"`
}

func (v StorageEfsResourceModel) ToUpdate() *StorageEfsResourceWritableModel {
	res := &StorageEfsResourceWritableModel{}
...
func (v *StorageEfsResourceModel) ToOrder() *OrderModel {
	return &OrderModel{
		Order:         v.Order,
...
func (v *StorageEfsResourceModel) MarshalJSON() ([]byte, error) {
