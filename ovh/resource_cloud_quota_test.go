	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				// current_state is computed and may drift between the PUT-poll
				// and the post-import read; checksum/updated_at can also shift.
				// regions: import adopts the singleton's full region list, which
				// won't equal the managed subset in pre-import state.
