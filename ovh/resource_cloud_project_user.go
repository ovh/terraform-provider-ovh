...
func cloudUserGetOpenstackRC(serviceName, id string, c *OVHClient, rc map[string]string) error {
...
func waitForCloudProjectUser(c *OVHClient, serviceName, id string) resource.StateRefreshFunc {
