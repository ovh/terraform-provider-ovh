...
const testAccCloudManagedDatabasesDatasourceConfig_Basic = `
...
func TestAccCloudManagedDatabasesDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedDatabasesDatasourceConfig_Basic,
		serviceName,
		description,
		engine,
		version,
