...
const testAccCloudManagedDatabaseIpRestrictionConfig = `
...
func TestAccCloudManagedDatabaseIpRestriction_basic(t *testing.T) {
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					resource.TestCheckResourceAttr(
						"ovh_cloud_managed_database_ip_restriction.ip",
