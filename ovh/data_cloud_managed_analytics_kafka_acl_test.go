...
const testAccCloudManagedAnalyticsKafkaAclDatasourceConfig_Basic = `
...
func TestAccCloudManagedAnalyticsKafkaAclDataSource_basic(t *testing.T) {
	...
	config := fmt.Sprintf(
		testAccCloudManagedAnalyticsKafkaAclDatasourceConfig_Basic,
		serviceName,
		description,
		version,
		region,
