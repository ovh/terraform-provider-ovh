...
// loadbalancerPoolDataSourceCurrentStateSchema returns the schema for the computed
// current_state attribute of a pool, shared by the singular and plural data sources.
func loadbalancerPoolDataSourceCurrentStateSchema() schema.SingleNestedAttribute {
