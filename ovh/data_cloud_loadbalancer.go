...
// loadbalancerDataSourceCurrentStateSchema returns the schema for the computed
// current_state attribute of a loadbalancer, shared by the singular and plural data sources.
func loadbalancerDataSourceCurrentStateSchema() schema.SingleNestedAttribute {
