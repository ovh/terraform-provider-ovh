...
# ovh_cloud_instance_groups (Data Source)
...
* `instance_groups` - Instance groups (placement groups) belonging to the project, across every region:
  * `id` - Unique identifier of the instance group, assigned at creation and used to reference it on the GET/DELETE routes.
