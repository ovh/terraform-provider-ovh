...
# ovh_vps_available_upgrade (Data Source)

Use this data source to retrieve the list of VPS models a given VPS service can be upgraded to.

## Example Usage

```terraform
data "ovh_vps_available_upgrade" "upgrades" {
...
* `models` - List of upgrade target models (same shape as `ovh_vps_models.models`).
