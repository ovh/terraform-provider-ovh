...
# ovh_cloud_managed_database_prometheus (Data Source)

Use this data source to get information about a prometheus of a database cluster associated with a public cloud project. For mongodb, please use ovh_cloud_managed_database_mongodb_prometheus datasource
...
output "name" {
  value = data.ovh_cloud_managed_database_prometheus.prometheus.username
}
```
