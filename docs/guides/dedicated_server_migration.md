...
-> If you are doing a first migration to v1.7.0, you should add the following parameter `reinstall_on_import = false` to the dedicated server resource. This guarantees you that the server won't be reinstalled after import, even if you have a diff on the reinstall-related parameters.
