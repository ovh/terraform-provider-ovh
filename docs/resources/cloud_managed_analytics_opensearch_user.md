...
# ovh_cloud_managed_analytics_opensearch_user
...
resource "ovh_cloud_managed_analytics_opensearch_user" "user_datetime" {
  service_name    = data.ovh_cloud_managed_analytics.opensearch.service_name
  cluster_id      = data.ovh_cloud_managed_analytics.opensearch.id
  acls {
    pattern    = "logs_*"
...
resource "ovh_cloud_managed_analytics_opensearch_user" "user_md5" {
  service_name    = data.ovh_cloud_managed_analytics.opensearch.service_name
  cluster_id      = data.ovh_cloud_managed_analytics.opensearch.id
  acls {
    pattern    = "logs_*"
...
```bash
$ terraform import ovh_cloud_managed_analytics_opensearch_user.my_user service_name/cluster_id/id
```
