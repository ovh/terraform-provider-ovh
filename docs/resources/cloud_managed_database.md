...
```terraform
resource "ovh_cloud_managed_database" "cassandradb" {
...
resource "ovh_cloud_managed_database" "kafkadb" {
  service_name          = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
resource "ovh_cloud_managed_database" "opensearchdb" {
  service_name            = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
resource "ovh_cloud_managed_database" "redisdb" {
  service_name  = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
resource "ovh_cloud_managed_database" "grafana" {
  service_name  = "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
...
* `plan` - (Required) Plan of the cluster.
  ...
  * Mysql, PosgreSQL, Cassandra: Enum: "essential", "business", "enterprise".
...
```bash
$ terraform import ovh_cloud_managed_database.my_database_cluster service_name/engine/id
```
