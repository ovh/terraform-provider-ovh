...
# ovh_cloud_managed_analytics_user
...
Create a user johndoe in a database. Output the user generated password with command `terraform output user_password`.
...
```bash
$ terraform import ovh_cloud_managed_analytics_user.my_user service_name/engine/cluster_id/id
```
