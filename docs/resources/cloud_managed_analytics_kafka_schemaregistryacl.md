...
# ovh_cloud_managed_analytics_kafka_schemaregistryacl
...
```bash
$ terraform import ovh_cloud_managed_analytics_kafka_schemaregistryacl.my_schemaRegistryAcl service_name/cluster_id/id
```
