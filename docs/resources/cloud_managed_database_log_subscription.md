...
# ovh_cloud_managed_database_log_subscription
...
resource "ovh_cloud_managed_database_log_subscription" "subscription" {
...
```bash
$ terraform import ovh_cloud_managed_database_log_subscription.sub service_name/engine/cluster_id/id
```
