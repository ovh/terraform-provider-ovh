...
# ovh_cloud_managed_database_redis_user
...
resource "ovh_cloud_managed_database_redis_user" "user_datetime" {
  service_name    = data.ovh_cloud_managed_database.redis.service_name
  cluster_id      = data.ovh_cloud_managed_database.redis.id
  categories      = ["+@set", "+@sortedset"]
  channels        = ["*"]
...
resource "ovh_cloud_managed_database_redis_user" "user_md5" {
  service_name    = data.ovh_cloud_managed_database.redis.service_name
  cluster_id      = data.ovh_cloud_managed_database.redis.id
  categories      = ["+@set", "+@sortedset"]
  channels        = ["*"]
...
```bash
$ terraform import ovh_cloud_managed_database_redis_user.my_user service_name/cluster_id/id
```
