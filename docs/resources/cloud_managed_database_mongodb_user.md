...
# ovh_cloud_managed_database_mongodb_user
...
resource "ovh_cloud_managed_database_mongodb_user" "user_datetime" {
  service_name  = data.ovh_cloud_managed_database.mongodb.service_name
  cluster_id    = data.ovh_cloud_managed_database.mongodb.id
  name          = "alice"
  roles         = ["backup@admin", "readAnyDatabase@admin"]
...
resource "ovh_cloud_managed_database_mongodb_user" "user_md5" {
  service_name  = data.ovh_cloud_managed_database.mongodb.service_name
  cluster_id    = data.ovh_cloud_managed_database.mongodb.id
  name          = "bob"
  roles         = ["backup@admin", "readAnyDatabase@admin"]
...
```bash
$ terraform import ovh_cloud_managed_database_mongodb_user.my_user service_name/cluster_id/id
```
