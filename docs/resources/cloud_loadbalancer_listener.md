...
* `default_pool_id` - (Optional) ID of the default pool for this listener (see [`ovh_cloud_loadbalancer_pool`](cloud_loadbalancer_pool.md)). If omitted, the value assigned by the API is stored in the state.
