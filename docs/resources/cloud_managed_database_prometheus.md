...
# ovh_cloud_managed_database_prometheus
...
resource "ovh_cloud_managed_database_prometheus" "prometheus_datetime" {
  service_name    = data.ovh_cloud_managed_database.db.service_name
  engine          = data.ovh_cloud_managed_database.db.engine
  cluster_id      = data.ovh_cloud_managed_database.db.id
...
resource "ovh_cloud_managed_database_prometheus" "prometheus_md5" {
  service_name    = data.ovh_cloud_managed_database.db.service_name
  engine          = data.ovh_cloud_managed_database.db.engine
  cluster_id      = data.ovh_cloud_managed_database.db.id
...
```bash
$ terraform import ovh_cloud_managed_database_prometheus.my_prometheus service_name/engine/cluster_id
```
