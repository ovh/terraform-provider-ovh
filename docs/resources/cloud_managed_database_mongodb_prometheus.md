...
# ovh_cloud_managed_database_mongodb_prometheus
...
```bash
$ terraform import ovh_cloud_managed_database_mongodb_prometheus.my_prometheus service_name/engine/cluster_id
```
