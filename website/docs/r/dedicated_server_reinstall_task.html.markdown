...
~> __WARNING__ Following links are OVHcloud API documentation. You might need to adapt camel case parameters to snake case parameters to fit terraform provider requirements (Example: `postInstallationScript` -> `post_installation_script`).
